...
- fly_to: 无人机飞行到指定 NED 坐标。前提：无人机必须在空中。north=正北, east=正东, down=向下（负值=向上）。 [参数: target_position, speed]
...
- get_position: 获取无人机当前的 GPS 坐标和 NED 局部坐标。 [参数: 无]
