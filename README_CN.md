...
- **(2026/3/24)** AerialClaw v2.0 更新 — AirSim 上海城市场景集成、自主城市巡检演示、GPT-4o 视觉感知、实时地图更新、Doctor Agent 适配器、WASD 手动控制、平滑插值飞行。
- **(2026/3/16)** AerialClaw v2.0 发布 — 安全包线、四层记忆、通用设备协议、自进化引擎、混合部署、AirSim 适配器、设备生命周期系统。
